...
echo ""
echo "⚠️  IMPORTANT: Update your .env file with this URL!"
echo ""
echo "To update N8N_URL in your .env file, run one of these:"
echo "  # macOS:"
echo "  sed -i '' 's|N8N_URL=.*|N8N_URL=$PUBLIC_URL|' .env"
echo "  # Linux:"
echo "  sed -i 's|N8N_URL=.*|N8N_URL=$PUBLIC_URL|' .env"
echo ""
echo "Or manually edit .env and set:"
echo "  N8N_URL=$PUBLIC_URL"
echo ""
echo "After updating .env, restart your Flask application."
echo ""
